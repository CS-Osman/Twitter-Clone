...
<body>
  <div class="top-bar bg-white shadow grid grid-cols-12 gap-4 px-8 py-3">
    ...
    <div class="col-span-10 flex items-center justify-between">
        <div>
          <form action="#" class="flex">
            <input type="text" class="border border-gray-400 py-2 px-2 w-128" placeholder="Search">
            <button type="submit" class="border border-gray-400 py-2 px-6 bg-grey-light hover:bg-grey-light">
              <i class="fa fa-search text-gray-500"></i>
            </button>
            {{-- <div>
              <a href="#"><i class="fa fa-lg border py-2 px-2 fa-microphone"></i></a>
            </div> --}}
          </form>
        </div>
        <div class="flex items-center mt-4">
          <a href="#"><i class="fa fa-upload fa-lg text-gray-500 mr-8"></i></a>
          <a href="#"><i class="fa fa-calendar text-gray-500  fa-lg mr-8"></i></a>
          <a href="#"><i class="fa fa-bell text-gray-500  fa-lg mr-8"></i></a>
          <a href="#"><img src="/img/Tiwter photo.jpeg" alt="avatar" class="rounded-full w-8 h-8 mr-6"></a>
        </div>
    </div> 
  </div> <!-- end top-bar -->
  <div class="youtube-body grid grid-cols-12">
    <div class="side-bar col-span-2 bg-grey-ligth py-6">
      <div class="mb-6">
        <a href="#" class="flex items-center py-3 px-6 mb-2 text-black transition-slow hover:bg-gray-200">
          <i class="fa fa-home fa-lg fa-fw text-gray-700 mr-4"></i>
          <span class="font-semibold text-sm">Home</span>
        </a>
        <a href="#" class="flex items-center py-3 px-6 mb-2 text-black transition-slow hover:bg-gray-200">
          <i class="fa fa-fire fa-lg fa-fw  text-gray-700 mr-4"></i>
          <span class="font-normal text-sm">Trending</span>
        </a>
        <a href="#" class="flex items-center py-3 px-6 mb-2 text-black transition-slow hover:bg-gray-200">
          <i class="fa fa-list fa-lg fa-fw text-gray-700 mr-4"></i>
          <span class="font-normal text-sm">Subscriptions</span>
        </a>
      </div>
      <div class="mb-6">
          <div class="uppercase px-6 text-gray-900 text-sm mb-4">Library</div> 
          <a href="#" class="flex items-center py-3 px-6 mb-2 text-gray-700 transition-slow hover:bg-gray-200">
            <i class="fa fa-clock-o fa-lg fa-fw text-gray-700 mr-4"></i>
            <span class="font-normal text-sm">Subscriptions</span>
          </a>
          <a href="#" class="flex items-center py-3 px-6 mb-2 text-gray-700 transition-slow hover:bg-gray-200">
      ...
      <div class="mb-6">
        <div class="uppercase px-6 text-gray-900 text-sm mb-4">Subscrbtion</div>
        <a href="#" class="flex items-center py-3 px-6 mb-2 text-gray-700 transition-slow hover:bg-gray-200">
          <img src="/img/Tiwter photo.jpeg" alt="Youtbe" class="rounded-full w-8 mr-5">
          <div class="text-sm">freeCodeCamp</div>
        </a>
        <a href="#" class="flex items-center py-3 px-6 mb-2 text-gray-700 transition-slow hover:bg-gray-200">
          <img src="https://github.com/drehimself/tailwind-examples/blob/master/public/img/youtube/avatar2.jpg?raw=true" alt="Youtbe" class="rounded-full w-8 mr-5">
          <div class="text-sm">john Doe</div>
        </a>
        <a href="#" class="flex items-center py-3 px-6 mb-2 text-gray-700 transition-slow hover:bg-gray-200">
          <img src="https://github.com/drehimself/tailwind-examples/blob/master/public/img/youtube/avatar3.jpg?raw=true" alt="Youtbe" class="rounded-full w-8 mr-5">
          <div class="text-sm">jeffry way</div>
        </a>
        <a href="#" class="flex items-center py-3 px-6 mb-2 text-gray-700 transition-slow hover:bg-gray-200">
          <img src="https://github.com/drehimself/tailwind-examples/blob/master/public/img/youtube/avatar4.jpg?raw=true" alt="Youtbe" class="rounded-full w-8 mr-5">
          <div class="text-sm">Adam Wathan</div>
        </a>
        <a href="#" class="flex items-center py-3 px-6 mb-2 text-gray-700 transition-slow hover:bg-gray-200">
          <img src="https://github.com/drehimself/tailwind-examples/blob/master/public/img/youtube/avatar5.jpg?raw=true" alt="Youtbe" class="rounded-full w-8 mr-5">
          <div class="text-sm">Black way</div>
        </a>
        <a href="#" class="flex items-center py-3 px-6 mb-2 text-gray-700 transition-slow hover:bg-gray-200">
          <i class="fa fa-chevron-down fa-fw text-gray-700 mr-8"></i>
          <div class="text-sm">Show 140 more</div>
        </a>
        <div class="mb-6">
          <div class="uppercase px-6 text-gray-900 text-sm mb-4">More From YouTube</div>
  
          <a href="#" class="flex items-center py-3 px-6 mb-6 text-black transition-slow hover:bg-gray-200">
            <i class="fa fa-film fa-lg fa-fw text-gray-700 mr-4"></i>
          ...
          <a href="#" class="flex items-center py-3 px-6 mb-2 text-black transition-slow hover:bg-grey">
            <i class="fa fa-cog fa-lg fa-fw text-gray-700 mr-4"></i>
            <div class="text-sm">Settings</div>
          </a>
  
          <a href="#" class="flex items-center py-3 px-6 mb-2 text-black transition-slow hover:bg-grey">
            <i class="fa fa-question-circle fa-lg fa-fw text-gray-700 mr-4"></i>
            <div class="text-sm">Help</div>
          </a>
  
          <a href="#" class="flex items-center py-3 px-6 mb-2 text-black transition-slow hover:bg-grey">
            <i class="fa fa-exclamation-triangle fa-lg fa-fw text-gray-700 mr-4"></i>
            <div class="text-sm">Send Feedback</div>
          </a>
        </div>
    </div>
    <div class="px-6 text-sm text-grey-darker">&copy; 2022 YouTube, LLC</div>
